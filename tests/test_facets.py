...
b_nes_c = NestedLabeledFacet(path =" b", nested_facet=TermsFacet(field = "b_nes.c"))



b_nes_d_keyword = NestedLabeledFacet(path =" b", nested_facet=TermsFacet(field = "b_nes.d.keyword"))



b_nes_f_g = NestedLabeledFacet(path =" b", nested_facet=TermsFacet(field = "b_nes.f.g"))
