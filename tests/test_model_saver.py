...
def test_model_saver_invenio():
    ...
    assert data[0]["model"] == {'api-blueprint': {'alias': 'test',
                                ...
                                'config': {'extra_code': '',
                                           ...
                                           'imports': [],
                                           'module': 'test.config'},
                                'edtf-interval-dumper': {'base-classes': [
                                    'oarepo_runtime.records.dumpers.edtf_interval.EDTFIntervalDumperExt'],
                                                         'class': 'test.records.dumpers.edtf.TestEDTFIntervalDumperExt',
                                                         'extensions': [],
                                                         'extra-code': '',
                                ...
                                'record': {'base-classes': ['invenio_rdm_records.records.api.RDMRecord'],
                                           'class': 'test.records.api.TestRecord',
                                           'extra-code': '',
                                           'fields': {},
                                           'generate': True,
               ...
               'config': {'extra_code': '',
                          ...
                          'module': 'test.config'},
               'edtf-interval-dumper': {
                   'base-classes': ['oarepo_runtime.records.dumpers.edtf_interval.EDTFIntervalDumperExt'],
                   'class': 'test.records.dumpers.edtf.TestEDTFIntervalDumperExt',
                   'extensions': [],
                   'extra-code': '',
                   'generate': True,
               ...
               'saved-model': {'alias': 'test',
                               ...
                               'module': 'test.models'},
               'search-options': {
                   'base-classes': ['invenio_records_resources.services.SearchOptions{InvenioSearchOptions}'],
                   'class': 'test.services.records.search.TestSearchOptions',
                   'extra-code': '',
                   'fields': {},
                   'generate': True,
