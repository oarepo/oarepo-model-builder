...
def test_prepare_datatype():
    ...
    assert record_section.definition == {'type': 'model', 'properties': {
        'metadata': {'type': 'object', 'properties': {},
                     'marshmallow': {'module': 'my.test.services.records.schema', 'generate': True,
                                     'class': 'my.test.services.records.schema.TestMetadataSchema', 'extra-code': '',
                                     'base-classes': ['marshmallow.Schema']}, 'ui': {
                'marshmallow': {'generate': True, 'module': 'my.test.services.records.ui_schema',
                                'class': 'my.test.services.records.ui_schema.TestMetadataUISchema', 'extra-code': '',
                                'base-classes': ['marshmallow.Schema']}}}}, 'searchable': True,
                                         'model-name': 'My Test Record',
                                         'module': {'qualified': 'my.test', 'alias': 'my_test_record',
                                                    'path': 'my/test', 'base': 'test', 'base-upper': 'TEST',
                                                    'base-title': 'Test', 'kebab-module': 'my-test', 'prefix': 'Test',
                                                    'prefix-upper': 'TEST', 'prefix-snake': 'test', 'suffix': 'test',
                                                    'suffix-upper': 'TEST', 'suffix-snake': 'test'},
                                         'sample': {'file': 'data/sample_data.yaml'},
                                         'ext-resource': {'generate': True, 'skip': False},
                                         'search-options': {'generate': True,
                                         ...
                                         'config': {'generate': True, 'module': 'my.test.config', 'extra_code': '',
                                                    'imports': []}, 'ext': {'generate': True, 'module': 'my.test.ext',
                                                                            'class': 'my.test.ext.TestExt',
                                                                            'base-classes': [], 'extra_code': '',
                                                                            'alias': 'my.test', 'imports': []},
                                         'api-blueprint': {'generate': True, 'alias': 'my_test_record',
                                                           'extra_code': '', 'module': 'my.test.views.records.api',
                                                           'function': 'my.test.views.records.api.create_api_blueprint',
                                                           'imports': []},
                                         'app-blueprint': {'generate': True, 'alias': 'my_test_record',
                                                           'extra_code': '', 'module': 'my.test.views.records.app',
                                                           'function': 'my.test.views.records.app.create_app_blueprint',
                                                           'imports': []},
                                         'facets': {'generate': True, 'module': 'my.test.services.records.facets',
                                                    'extra-code': '', 'groups': True},
                                         'record': {'generate': True, 'module': 'my.test.records.api',
                                         ...
                                         'resource': {'generate': True, 'config-key': 'TEST_RECORD_RESOURCE_CLASS',
                                                      ...
                                                      'proxy': 'current_resource', 'extra-code': '', 'base-classes': [
                                                 'invenio_records_resources.resources.RecordResource'], 'imports': [],
                                                      'additional-args': []},
                                         'resource-config': {'generate': True, 'base-url': '/my-test/',
                                         ...
                                         'saved-model': {'file': 'my/test/models/records.json',
                                                         'module': 'my.test.models', 'alias': 'my_test_record'},
                                         'proxy': {'module': 'my.test.proxies', 'generate': True},
                                         'json-schema-settings': {'generate': True, 'alias': 'my_test_record',
                                                                  'version': '1.0.0',
                                                                  'module': 'my.test.records.jsonschemas',
                                                                  'name': 'test-1.0.0.json',
                                                                  'file': 'my/test/records/jsonschemas/test-1.0.0.json'},
                                         'pid': {'generate': True, 'type': 'mytcrd', 'module': 'my.test.records.api',
                                         ...
                                         'record-dumper': {'generate': True, 'module': 'my.test.records.dumpers.dumper',
                                                 ...
                                                 '{{my.test.records.dumpers.edtf.TestEDTFIntervalDumperExt}}()'],
                                                           'imports': []},
                                         'record-metadata': {'generate': True, 'module': 'my.test.records.models',
                                                             ...
                                                             'alias': 'my_test_record', 'use-versioning': True,
                                                             'alembic': 'my.test.alembic'},
                                         'service-config': {'generate': True,
            ...
            'marshmallow': {'generate': True, 'module': 'my.test.services.records.ui_schema',
                            'class': 'my.test.services.records.ui_schema.TestUISchema', 'extra-code': '',
                            'base-classes': ['oarepo_runtime.services.schema.ui.InvenioUISchema'], 'imports': []}},
                                         'json-serializer': {'module': 'my.test.resources.records.ui',
                                         ...
                                         'mapping': {'generate': True, 'alias': 'my_test_record',
                                                     ...
                                                     'index-field-args': []},
                                         'marshmallow': {'generate': True, 'module': 'my.test.services.records.schema',
                                                         'class': 'my.test.services.records.schema.TestSchema',
                                                         'extra-code': '', 'base-classes': ['marshmallow.Schema',
                                         ...
                                         'permissions': {'generate': True, 'presets': ['everyone'], 'extra-code': '',
                                                         ...
                                                         'imports': []}, 'edtf-interval-dumper': {'generate': True,
                                                                                                  ...
                                                                                                  'extensions': [],
                                                                                                  'imports': []},
                                         'record-list': {'generate': True, 'module': 'my.test.services.records.results',
                                                         'class': 'my.test.services.records.results.TestRecordList',
                                                         'extra-code': '',
                                                         'base-classes': ['oarepo_runtime.services.results.RecordList'],
                                                         'components': [], 'imports': []},
                                         'record-item': {'generate': True, 'module': 'my.test.services.records.results',
