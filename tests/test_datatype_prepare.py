...
def test_prepare_datatype():
    ...
    assert record_section.definition == {'api-blueprint': {'alias': 'my_test_record',
                   'extra_code': '',
 ...
 'mapping-settings': {'alias': 'my_test_record',
 ...
 'module': {'alias': 'my_test_record',
            ...
            'suffix-snake': 'test',
            'suffix-upper': 'TEST'},
 'permissions': {'base-classes': ['RecordPermissionPolicy'],
                 'class': 'my.test.services.records.permissions.TestPermissionPolicy',
                 'extra-code': '',
                 'generate': False,
                 'imports': [{'import': 'invenio_records_permissions.RecordPermissionPolicy'}],
                 'module': 'my.test.services.records.permissions',
                 'presets': ['everyone']},
 'pid': {'context-class': 'PIDFieldContext',
         'field-args': ['create=True'],
         'field-class': 'PIDField',
         'generate': True,
         'imports': [{'import': 'invenio_records_resources.records.systemfields.pid.PIDField'},
         ...
         'type': 'mytcrd'},
 'properties': {'metadata': {'marshmallow': {'base-classes': ['ma.Schema'],
                             ...
                             'properties': {},
                             'type': 'object',
                             'ui': {'marshmallow': {'base-classes': ['ma.Schema'],
 ...
 'record': {'base-classes': ['InvenioRecord'],
            'class': 'my.test.records.api.TestRecord',
            'extra-code': '',
            'generate': True,
            'imports': [{'alias': 'InvenioRecord',
                         'import': 'invenio_records_resources.records.api.Record'}],
            'module': 'my.test.records.api'},
 'record-dumper': {'base-classes': ['SearchDumper'],
 ...
 'service-config': {'base-classes': ['PermissionsPresetsConfigMixin',
                    ...
                    'extra-code': '',
                    'generate': True,
                    'imports': [{'alias': 'InvenioRecordServiceConfig',
