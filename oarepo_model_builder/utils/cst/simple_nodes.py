from .common import MergerBase, real_node, real_with_changes, IdentityBaseMerger, PythonContext
...
class AssignMerger(MergerBase):
    def merge(self, context: PythonContext, existing_node, new_node):
        ...
        merged_value = self.check_and_merge(context, real_existing.value, real_new.value, expression_mergers)
        if merged_value:
