...
class ServiceConfigClassSchema(ma.Schema):
    ...
    search_item_links_template_cls = ma.fields.String(attribute="search-item-links-template-cls",
...
class ServiceModelComponent(DataTypeComponent):
    ...
    def before_model_prepare(self, datatype, *, context, **kwargs):
        ...
        config.setdefault("search-item-links-template-cls", "invenio_records_resources.services.LinksTemplate")
